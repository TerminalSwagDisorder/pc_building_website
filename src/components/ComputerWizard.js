...
const ComputerWizard = ({
  ...
  const formatWizardBuilds = () => {
    if (currentUser.Completed_builds) {
      ...
      return completedBuilds.map((build) => (
        <div className="Result" key={build.ID}>
  ...
  const renderComputerWizard = () => {
    if (
      currentOperation === "wizard" ||
      currentOperation === "wizardAdvanced"
    ) {
      return (
        <div id="userform">
          <form onSubmit={handleSubmit} className="wizardForm">
            ...
            <br></br>
            <div>
              <label for="price" className="wizardLabel">
                Max price (500-5000):{" "}
              </label>
              <br></br>
              <input
            ...
            <br></br>
            <div>
              <label for="useCase" className="wizardLabel">
                Use case:{" "}
              </label>
              <br></br>
              <select
            ...
            <br></br>
            <div>
              <label for="performancePreference" className="wizardLabel">
            ...
            <br></br>
            <div>
              <label for="formFactor" className="wizardLabel">
                Size preference:{" "}
              </label>
              <br></br>
              <select
            ...
            <br></br>
            <div>
              <label for="colorPreference" className="wizardLabel">
                Color preference:{" "}
              </label>
              <br></br>
              <select
            ...
            <br></br>
            <div>
              <label for="rgbPreference" className="wizardLabel">
      ...
      return (
        <div className="userCredentialChange">
          <div>
            <button onClick={() => handleComputerWizardForm("wizard")}>
              Start to build a computer!
            </button>
          </div>
        </div>
      );
  ...
  const renderAdvancedComputerWizard = () => {
    if (currentOperation === "wizardAdvanced") {
      return (
        <div>
          <div>
            <label for="cpuManufacturer" className="wizardLabel">
              Cpu manufacturer:{" "}
            </label>
            <br></br>
            <select
          ...
          <br></br>
          <div>
            <label for="gpuManufacturer" className="wizardLabel">
              Gpu manufacturer:{" "}
            </label>
            <br></br>
            <select
          ...
          <br></br>
          <div>
            <label for="psuBias" className="wizardLabel">
              Power supply bias:{" "}
            </label>
            <br></br>
            <select
            ...
            >
              <option value="noPreference">No preference</option>
              <option value="bestEfficiency">
                Better efficiency/Lower wattage
              </option>
              <option value="balanced">Balanced efficiency & wattage</option>
              <option value="highWattage">
                Higher wattage/Worse efficiency
              </option>
            </select>
          </div>
          <br></br>
          <div>
            <label for="storageBias" className="wizardLabel">
              Storage bias:{" "}
            </label>
            <br></br>
            <select
            ...
            >
              ...
              <option value="bootSsd">
                Boot SSD with any mixture of storage
              </option>
          ...
          <br></br>
          <div>
            <label for="additionalStorage" className="wizardLabel">
              Additional storage:{" "}
            </label>
            <br></br>
            <select
  ...
  const renderAdvancedButton = () => {
    if (currentOperation === "wizardAdvanced") {
      return (
        <div>
          <h3
            className="setWizardAdvanced"
            onClick={() => handleComputerWizardForm("wizard")}
          >
            Advanced ▲
          </h3>
        </div>
      ...
      return (
        <div>
          <h3
            className="setWizardAdvanced"
            onClick={() => handleComputerWizardForm("wizardAdvanced")}
          >
            Advanced ▼
          </h3>
        </div>
  ...
  return (
    <div className="result">
      ...
      <div className="Results">{formatWizardBuilds()}</div>
    </div>
  );
};
