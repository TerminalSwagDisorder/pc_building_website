      ...
      <Row className="justify-content-center">
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowCases(!showCases)}>
            Cases{showCases ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showCases && (
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowCpus(!showCpus)}>
            CPUs{showCpus ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showCpus && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowCpuCoolers(!showCpuCoolers)}>
            CPU Coolers{showCpuCoolers ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showCpuCoolers && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowGpus(!showGpus)}>
            GPUs{showGpus ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showGpus && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowMemories(!showMemories)}>
            Memories{showMemories ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showMemories && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowMotherboards(!showMotherboards)}>
            Motherboards{showMotherboards ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showMotherboards && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowPsus(!showPsus)}>
            PSUs{showPsus ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showPsus && (
            <div className="component-list">
              <ul>
        ...
        <Col xs={12} sm={6} md={3}>
          <h2 className="componentsh2" onClick={() => setShowStorages(!showStorages)}>
            Storages{showStorages ? <span className="arrow">▲</span> : <span className="arrow">▼</span>}
          </h2>
          {showStorages && (
            <div className="component-list">
              <ul>
